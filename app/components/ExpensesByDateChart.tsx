...
const ExpensesByDateChart: React.FC<ExpensesByDateChartProps> = ({ expenses }) => {
  ...
  const labels = Object.keys(groupedExpenses).sort((a, b) => new Date(a).getTime() - new Date(b).getTime());
  ...
  const chartOptions = {
    ...
    scales: {
      x: {
        ...
        time: {
          unit: 'day', // Define a unidade de tempo (dia)
